...
<div class="container shop_list">
    ...
    <div class="shop_contents">
        ...
        <ul class="clear col-md-3 col-sm-3 col-xs-12 clear">
            <li class="shop_postal_code">〒&nbsp;880-0121</li>
            <li class="shop_address">宮崎市大字島之内字永池9217番地107</li>
        ...
        <span class="col-md-8 col-sm-8 col-xs-12 shop_image">
            <img src="<?php bloginfo('template_directory'); ?>/img/shop/minori.png" alt="みのり薬局">
        </span>
    </div>
    <h3>お知らせ</h3>
    <ul>
